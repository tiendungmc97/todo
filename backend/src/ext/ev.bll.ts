...
import { MongoDB, MongoCommon, MongoModel } from "../lib/mongodb";
...
export class EventBLLBase implements EventNS.BLL {
  ...
  private col_ev_one = this.db.collection<MongoModel<any>>('ev_one');
  private col_ev_one_fail = this.db.collection<MongoModel<any>>('ev_one_fail');
